...
class ScaleModifier extends Modifier {
  inline function lerp(a:Float,b:Float,c:Float){
	...
	function getScale(sprite:Dynamic, scale:TypePoint, data:Int, player:Int){
	...
	override function getReceptorScale(receptor:Receptor, scale:TypePoint, data:Int, player:Int){
    return getScale(receptor,scale,data,player);
  }

	override function getNoteScale(note:Note, scale:TypePoint, data:Int, player:Int){
