...
class Modifier {
  ...
  public var parent:Modifier; // if its a submod then this gets set
  ...
  public function setPercent(percent:Float, player:Int=-1){
	...
	public function updateNote(note:Note, player:Int, pos:Vector3, scale:TypePoint){}
	public function updateReceptor(receptor:Receptor, player:Int, pos:Vector3, scale:TypePoint){}

  public function update(elapsed:Float){};

	public function getReceptorScale(receptor:Receptor, scale:TypePoint, data:Int, player:Int)return scale;
	public function getNoteScale(note:Note, scale:TypePoint, data:Int, player:Int)return scale;
