...
class EngineData {
  ...
  public static var events:Array<EventInfo> = [
      ...
      arguments: [
        {
          ...
          defaultVal: "im",
          dropdownValues: ["im","not","finished","yet","merchant"]
        }
      ]
    },

    {
      name: "End Merchant Dialogue",
      arguments: [
    ...
    {
      name: "DMPiiking Out RN!!",
      arguments: []
    },

    {
      name: "Closeup Trans BEGONE",
      arguments: []
    },
    
    {
			name: "Malvado Stage Change",
      arguments: [],
    },
  ...
  public static var noteTypes:Array<String> = ["default","alt","mine","loan"];
  ...
  public static var weekData:Array<WeekData> = [
    new WeekData("Fiesta de Fuego",0,'flexy',[
      "Noche",
      "Desierto",
      new SongData("Globetrotter","dmp",0,"globetrotter",'fiesta'),
      new SongData("Gran Venta","merchant",0,"gran-venta",'fiesta')
    ],'bf','gf','fiesta'),
    new WeekData("Lost Hope",1,'corruptedflexy',[
      new SongData("Devoured","corruptedflexy",1,"devoured","fiesta"),
      new SongData("Malvado","corruptedmerchant",1,"malvado","fiesta"),
    ],'corruptedbf','gf','corruption'),
    new WeekData("Merry Flexmas",2,'clayflexy',[
      new SongData("Snowflek","clayflexy",2,"snowflek","fiesta"),
    ],'bf','gf','flexmas')
  ];
