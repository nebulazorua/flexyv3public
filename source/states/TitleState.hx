...
class TitleState extends MusicBeatState
{
	...
	{
		super.beatHit();
		if (logoBl==null)return; // PREMATURE BEATJACULATION
		logoBl.animation.play('bump');
		danceLeft = !danceLeft;
		...
		{
			case 1:
				createCoolText(['ravvytavvy', 'echolocated', 'nebula the zorua', 'and']);
			// credTextShit.visible = true;
			case 3:
				addMoreText('the flexy team');
			// credTextShit.text += '\npresent...';
			...
			// credTextShit.screenCenter();
			case 5:
				createCoolText(['a certified']);
			case 7:
				addMoreText('flexy experience');
				ngSpr.visible = true;
			// credTextShit.text += '\nNewgrounds';
			case 8:
				deleteCoolText();
			...
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('Flexin'); // credTextShit.text += '\nFunkin';
