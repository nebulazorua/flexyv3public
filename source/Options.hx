...
class Options
{
	...
	public var judgementWindow:String = 'Standard';
...
class CallbackOption extends Option
{
	private var callback:CallbackOption->Null<Bool>;
	public function new(name:String, callback:CallbackOption->Null<Bool>){
		super();
		this.name=name;
