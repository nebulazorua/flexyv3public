...
class CoolUtil
{
	public static var difficultyArray:Array<String> = ['EASY', "NORMAL", "HARD", "STEPPED UP"];
	...
	public inline static function snapNum(num:Float, snap:Float=1, next:Float=0, round:Float=0.5)
		return Math.floor((num / snap) + round) * snap + (next * snap);
